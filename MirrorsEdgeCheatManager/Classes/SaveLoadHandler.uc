/**
 *  Class for providing persistent saving and loading of player states (SaveLocation and TpToSavedLocation functions in MirrorsEdgeCheatManager class)
 *
...
class SaveLoadHandler extends Object
    config(Game);
